-- Declarative Schema for Prototypes Table
-- This file defines the desired final state of the prototypes table

-- Create enum type for prototype stages
DO $$ BEGIN
...
-- RLS Policies for prototypes table
